...
1. This can be tested by using your Entra ID credentials, Open a private browser and navigate to <login.microsoftonline.com> and Enter an incorrect password repeatedly until the account receives a notification that it has been locked out, as shown in the screenshot.
